...
public class DBManager {
    ...
    public static List<String[]> queryAllCityName(){
        ...
        while (cursor.moveToNext()) {
            ...
            cityInfo[0] = cursor.getString(cursor.getColumnIndex("city"));
            cityInfo[1] = cursor.getString(cursor.getColumnIndex("citycode"));
    ...
    public static List<DatabaseBean>queryAllInfo(){
        ...
        while (cursor.moveToNext()) {
            ...
            DatabaseBean bean = new DatabaseBean(id, city, content,cityCode);
            list.add(bean);
        }
        return list;
    }
